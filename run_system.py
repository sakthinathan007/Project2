...
# ─────────────────────────────────────────────
# TRAIN XGBoost MODELS  (lightweight for Jupyter)
# ─────────────────────────────────────────────
...
# ─────────────────────────────────────────────
FALLBACK_ROUTES = {
    "MG Road"                : "Mount Road / Brigade Road",
    "Anna Nagar"             : "Poonamallee High Road",
    "T. Nagar"               : "Kodambakkam High Road",
    "ECR Highway"            : "OMR Road",
    "Airport Road"           : "GST Road",
    "OMR Tech Park"          : "Rajiv Gandhi Salai",
    "Koyambedu Junction"     : "Poonamallee High Road",
    "Besant Nagar"           : "ECR Road",
    "Velachery"              : "Taramani Road",
    "Adyar"                  : "LB Road",
    "Tambaram"               : "GST Road",
    "Porur"                  : "Mount-Poonamallee Road",
    "Guindy"                 : "Inner Ring Road",
    "Mount Road"             : "Anna Salai Bypass",
    ...
    "Hebbal Flyover"         : "Bellary Road Service Road",
    "Yeshwanthpur"           : "Tumkur Road",
    "Bannerghatta Road"      : "Kanakpura Road",
    "JP Nagar"               : "Kanakapura Road",
    "KR Puram"               : "Old Madras Road",
    "Bellandur"              : "Sarjapur Road",
    "Bandra-Worli Sea Link"  : "LBS Marg",
    "Western Express Highway": "SV Road",
    "Eastern Express Highway": "LBS Marg",
    "Andheri Junction"       : "JVLR",
    "Dadar TT Circle"        : "Dr Ambedkar Road",
    "Thane Junction"         : "Ghodbunder Road",
    "Borivali"               : "Western Railway Parallel Road",
    "Kurla Junction"         : "CST Road",
    "Bandra Kurla Complex"   : "Western Express Highway Service Road",
    "Lower Parel"            : "Senapati Bapat Marg",
    "Chembur"                : "Sion-Trombay Road",
    "Connaught Place"        : "Barakhamba Road",
    "Dwarka Expressway"      : "NH-48",
    "NH-48 Delhi"            : "Dwarka Expressway",
    "Chandni Chowk"          : "Nai Sarak",
    "Nehru Place"            : "Outer Ring Road",
    "Lajpat Nagar"           : "Ring Road",
    "Rohini Sector 18"       : "Outer Ring Road North",
    "Noida Sector 18"        : "Expressway Service Road",
    "Cyber City Gurugram"    : "Golf Course Road",
    "Faridabad NH-19"        : "Delhi-Agra Bypass",
    "HiTech City"            : "Outer Ring Road",
    "Gachibowli"             : "ISB Road",
    "LB Nagar Junction"      : "Vijayawada Highway",
    "Secunderabad Junction"  : "SP Road",
    "Ameerpet"               : "Punjagutta Road",
    "Banjara Hills Road No.1": "Road No.12",
    "Kukatpally"             : "KPHB Road",
    "Paradise Circle"        : "Sardar Patel Road",
    "FC Road"                : "Bhandarkar Road",
    "Hinjewadi IT Park"      : "Mumbai-Bangalore Bypass",
    "Kothrud"                : "Law College Road",
    "Pimpri Chowk"           : "Old Mumbai-Pune Highway",
    "Swargate"               : "Satara Road",
    "Viman Nagar"            : "Nagar Road",
    "Hadapsar"               : "Solapur Road",
    "Esplanade"              : "Strand Road",
    "Park Street"            : "AJC Bose Road",
    "Howrah Bridge"          : "Vivekananda Setu",
    "Salt Lake Sector V"     : "EM Bypass",
    "EM Bypass"              : "VIP Road",
    "New Town"               : "Rajarhat Road",
    "RS Puram"               : "DB Road",
    "Gandhipuram"            : "Cross Cut Road",
    "Peelamedu"              : "Avinashi Road Service Road",
    "Ukkadam Junction"       : "Trichy Road",
}

def get_route(row):
    return FALLBACK_ROUTES.get(row.get("name", ""), "Ring Road / Bypass Road")


# ─────────────────────────────────────────────
# PRINT OUTPUT
# ─────────────────────────────────────────────
def show_output(row, models, encoders):
    print("\n" + "=" * 55)
    ...
    print("\n🛣️  Recommendation:")
    if "Heavy" in status:
        print(f"  🚨 Heavy traffic expected at {row['name']}!")
        print(f"  ➡️  Use alternate route: {route}")
    elif "Moderate" in status:
        print(f"  ⚠️  Moderate congestion — consider: {route}")
    else:
        print(f"  ✅ Traffic is smooth. No alternate route needed.")
...
def launch_ui(df, models, encoders):
    ...
    def on_click(_):
        ...
        with out:
            clear_output()
            show_output(row, models, encoders)
